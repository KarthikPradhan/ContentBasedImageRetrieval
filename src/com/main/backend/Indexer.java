...
public class Indexer {
	...
	public void indexingOfFiles(String fileDir) throws IOException {

		// Checking if arg[0] is there and if it is a directory.
		boolean passed = false;
		if (fileDir.length() > 0) {
			File f = new File(fileDir);
			System.out.println("Indexing images in " + fileDir);
		...
		ArrayList<String> images = FileUtils.readFileLines(new File(fileDir), true);
